...
<div class='col-xs-6'>
<select id='asentamiento' name='asentamiento' id='asentamiento' class='form-control' onChange='consulta_info_asentamiento(this.value);'>
...
<label for='zona_txt' class='control-label col-xs-2'>&Aacute;mbito</label>
<div class='col-xs-6'>
...
<div class='col-xs-6'>
<select class='form-control' name='tipo_vial' id='tipo_vial'>
".$vialidad."
</select>
</div>
</div>
...
<div class='col-xs-6'>
<input type='text' name='n_vialidad' id='n_vialidad' class='form-control' required>
</div>
</div>
...
<div class='col-xs-6'>
<input type='text' name='ne_txt' id='ne_txt' class='form-control'>
</div>
</div>
