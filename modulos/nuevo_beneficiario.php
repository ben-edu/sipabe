...
<form class="form-horizontal" name="nuevo_cc_form" id="nuevo_cc_form" action="main.php?token=<?php print(md5(9)); ?>" method="post">
<div class='row'>
<div class='col-xs-12'>
...
<div class="col-xs-6">
<input type="text" class="form-control" placeholder="Primer apellido" name="FirstA" id= "FirstA">
</div>
</div>
...
<div class='form-group'>
<label for='estudio_dep' class='control-label col-xs-2'>Estudio Socioeconómico</label>
<div class="col-lg-6">
<div class="input-group">
<span class="input-group-addon">
<input type="checkbox" name='e_demografico'>
</span>
<input type="text" class="form-control" value="Estudio socioeconómico por parte de la dependencia" disabled="disabled">
</div>
</div>
</div>

<div class="form-group">
<label for="perfil_s" class="control-label col-xs-2">Perfil Socioeconómico</label>
<div class="col-xs-6">
...
<div class="col-xs-6">
<input type="number" class="form-control" name="dependientes">
</div>
</div>
...
<div class="col-xs-6">
<input type="number" class="form-control" name="habitantes_vivienda">
</div>
</div>
...
<option value='0'>-Seleccione-</option>
<?php
$cons_dep = "SELECT id_dependencia,nombre FROM dependencias ORDER BY id_dependencia ASC";
$ex_dep = $conexion->query($cons_dep);
while($r_dep = $ex_dep->fetch_assoc()){
	echo "<option value='".$r_dep['id_dependencia']."'>".$r_dep['nombre']."</option>";
}
?>
</select>
</div>
...
<div class="col-xs-6">
<input type="text" class="form-control" name="clave_presupuestal">
</div>
</div>
...
<div class="input-group col-xs-6">
<span class="input-group-addon">$</span>
<input type="number" class="form-control" name='importe_apoyo' required>
</div>
</div>

<div class="form-group">
<label for="perfil_s" class="control-label col-xs-2">Num de Apoyos</label>
<div class="col-xs-6">
<input type="number" class="form-control" name="num_apoyos" required>
</div>
</div>
...
<div class="col-xs-6">
<input type="date" class="form-control" name="fecha_apoyo">
</div>
</div>
...
<div class="form-group">
<label for="perfil_s" class="control-label col-xs-2">Ben. Colectivo</label>
<div class="col-xs-6">
<div class="input-group">
<span class="input-group-addon">
<input type="checkbox" name="ben_colectivo">
</span>
<input type="text" class="form-control" name="nombre_grupo_col">
</div>
</div>
</div>
...
<div class="col-xs-6">
<select  id='origen_recurso' class="form-control" name="origen_recurso">
  <?php
  $cons_origen_recurso = "SELECT * FROM origen_recurso";
  $ex_origen_recurso = $conexion->query($cons_origen_recurso);
  echo "<option value='0'> - seleccione - </option>";
 while($r_origen_recurso = $ex_origen_recurso->fetch_assoc()){
   echo "<option value='".$r_origen_recurso['id_origen']."'>".$r_origen_recurso['origen']."</option>";
 }
...
<div class="form-group">
<label for="perfil_s" class="control-label col-xs-2">Teléfono</label>
<div class="col-xs-6">
